...
plt.hist(not_default, bins=15, alpha=0.5, color='lightgreen', label='No Default (0)', density=True)
plt.hist(default, bins=15, alpha=0.5, color='coral', label='Default (1)', density=True)
sns.kdeplot(not_default, color='lightgreen', linewidth=2, label='No Default (0)')
sns.kdeplot(default, color='coral', linewidth=2, label='Default (1)')
