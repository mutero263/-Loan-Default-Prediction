...
plt.hist(not_default, bins=20, alpha=0.5, color='teal', label='No Default (0)', density=True)
plt.hist(default, bins=20, alpha=0.5, color='lightpink', label='Default (1)', density=True)
sns.kdeplot(not_default, color='teal', linewidth=2, label='No Default (0)')
sns.kdeplot(default, color='lightpink', linewidth=2, label='Default (1)')
