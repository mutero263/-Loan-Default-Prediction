...
sns.histplot(df[col], kde=True, ax=axes[0], color='crimson')
sns.boxplot(y=df[col], ax=axes[1], color='beige')
sns.barplot(data=df, x='default', y=col, ax=axes[2], palette='coolwarm')
