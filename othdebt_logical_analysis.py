...
sns.histplot(df[col], kde=True, ax=axes[0], color='darkgreen')
sns.boxplot(y=df[col], ax=axes[1], color='moccasin')
sns.barplot(data=df, x='default', y=col, ax=axes[2], palette='rainbow')
