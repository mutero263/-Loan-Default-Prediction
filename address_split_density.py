...
plt.hist(not_default, bins=15, alpha=0.5, color='plum', label='No Default (0)', density=True)
plt.hist(default, bins=15, alpha=0.5, color='orange', label='Default (1)', density=True)
sns.kdeplot(not_default, color='plum', linewidth=2, label='No Default (0)')
sns.kdeplot(default, color='orange', linewidth=2, label='Default (1)')
